...
struct ToolRuntimeTests {
    ...
    @Test func definitionsAndRegistryAreStable() async throws {
        ...
        #expect(runtime.definitions.map(\.id.rawValue) == ["apply_patch", "context_recall", "edit_file", "git", "glob", "grep", "list_directory", "manage_background_command", "process", "question", "read_file", "run_background_command", "shell", "skill", "todo", "web_fetch", "web_search", "write_file"])
