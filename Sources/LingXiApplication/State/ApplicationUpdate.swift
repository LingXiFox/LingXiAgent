...
/// 表示时间线节点的单次结构或数据演进。
public struct TimelineNodeChange: Sendable, Equatable, Hashable, Codable {
    /// Codable as the bare case name string, e.g. "append".
...
public struct ApplicationChangeSet: Sendable, Equatable, Codable {
...
/// Codable so a remote frontend receives exactly what the in-process frontends consume.
public struct ApplicationUpdate: Sendable, Equatable, Codable {
