...
public enum CoreEvent: Sendable, Equatable {
    ...
    case childSessionCreated(SessionInfo)
    case subagentSpawned(AgentRunInfo)
    case agentRunQueued(AgentRunInfo)
    case agentRunStarted(AgentRunInfo)
    case agentRunStatusChanged(AgentRunInfo)
    case agentRunCompleted(AgentRunInfo)
    case agentRunFailed(AgentRunInfo)
